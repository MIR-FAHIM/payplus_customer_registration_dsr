                                ...
                                children: [
                                  InkWell(
                                    onTap: () {
                                      ...
                                      print(
                                          "pu pu ${controller.imeiNumber.value}");
                                    },
                                    child: Container(
                                      child: Text(
                                        "Forget Pin?".tr,
                            ...
                            children: [
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  margin: EdgeInsets.all(_size.width * .04),
                                  decoration:
                                      Ui.getBoxDecoration(color: Colors.white),
                                  child: Form(
                                    autovalidateMode:
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            InkWell(
                                              onTap: () {
                                                if (controller.mobileNumber
                                                        .value.length ==
                                                    11) {
                                                  var data = {
                                                    "mobileNumber": controller
                                                        .mobileNumber.value,
                                                    "imeiNumber": controller
                                                        .imeiNumber.value,
                                                  };

                                                  Get.toNamed(
                                                      Routes.Forget_pass_otp,
                                                      arguments: data);
                                                  print("LoginView");
                                                  print(controller
                                                      .mobileNumber.value);
