...
class SpecialRatePackageWidget extends GetWidget<RechargeController> {
  final _size = Get.size;
  @override
  Widget build(BuildContext context) {
    return Obx(() {
      if (controller.specialRateLoaded.isTrue) {
        return Column(
          children: List.generate(controller.specialRatePackage.length, (index) {
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                              child: Text(
                                                controller.specialRatePackage[index]
                                                    .package!,
                                                style: TextStyle(
                                            ...
                                            child: Center(
                                              child: Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      '৳${controller.specialRatePackage[index].offerAmount!}',
                                                      style: TextStyle(
                                                          color: Colors.white,
                                                          fontSize: 12,
                                                          fontWeight:
