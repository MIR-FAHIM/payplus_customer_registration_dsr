...
class DataOfferOperator extends GetWidget<RechargeController> {
  DataOfferOperator({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final offers = controller.specialDataOfferList;
          ...
          itemBuilder: (_, index) {
            ...
            return _OfferCard(
              ...
              onTap: () {
                ...
                controller.specialCampaignID.value = data.campaignId.toString();
                controller.specialOfferID.value = data.offerId.toString();
