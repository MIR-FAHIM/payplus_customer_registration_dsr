                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: GridView.count(
                              ...
                              children: controller.paymentTypesVisaMast.value.isEmpty ?
                              Ui.customLoaderDialog()
                                  :List.generate(
                                  controller.paymentTypesVisaMast.value.length, (index) {
                                    var data =  controller.paymentTypesVisaMast.value[index];
                                return GestureDetector(
                                  onTap: () {
                                    ...
                                    if (controller.paymentMethodId.value == 3) {
                                      ...
                                      controller
                                          .getAddPaymentUrlVisa(data.code == "visa" ? "2" : "1")
                                          .then((e) {
                                        if (e == true) {
                                          print(
                                              "hlw moho +++++++++++++++++++++++++++++++++");
