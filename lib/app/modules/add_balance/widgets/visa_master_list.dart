      ...
      return Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            leading: IconButton(
              onPressed: () {
                //   controller.getImage(ImageSource.camera, "card");
                Get.back();
              },
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              controller.paymentTypesVisaMast.value.isEmpty
                  ? Container(
                      height: _size.height,
                      width: _size.width,
                      child: Center(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: GridView.count(
                                    ...
                                    children:
                                        controller.paymentTypesVisaMast.value
                                                .isEmpty
                                            ? Ui.customLoaderDialog()
                                            : List.generate(
                                                controller.paymentTypesVisaMast
                                                    .value.length, (index) {
                                                var data = controller
                                                    .paymentTypesVisaMast
                                                    .value[index];
                                                return GestureDetector(
                                                  onTap: () {
                                                    ...
                                                    controller.paymentOptionId
                                                            .value =
                                                        data.id!.toString();
                                                    controller.paymentMethodCode
                                                            .value =
                                                        data.code!.toString();
                                                    print(
                                                        "code is ${controller.paymentMethodCode.value}");
                                                              ...
                                                              children: [
                                                                Container(
                                                                  child: Row(
                                                                    children: [
                                                                      ...
                                                                      Container(
                                                                        height: controller.grpValue.value ==
                                                                                3
                                                                            ? 80
                                                                            : 80,
                                                                        width: controller.grpValue.value ==
                                                                                3
                                                                            ? 80
                                                                            : 80,
                                                                        decoration:
                                                                ...
                                                                Container(
                                                                  ...
                                                                  decoration:
                                                                    ...
                                                                    border: Border.all(
                                                                        color: StickyColors
                                                                            .colors[controller.random.nextInt(
                                                                                6)]
                                                                            .withOpacity(
                                                                                .5),
                                                                        width:
