...
class RtnBankListView extends GetView<AddbalanceController> {
    ...
    return Obx(
          ...
          return Scaffold(
            ...
            body: SingleChildScrollView(
              child: Column(
                children: [
                  controller.rtnBankList.value.isEmpty
                      ? Container(
                    height: _size.height,
                    width: _size.width,
                    child: Center(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: GridView.count(
                              ...
                              children: controller.rtnBankList.isEmpty ?
                              Ui.customLoaderDialog()
                                  :List.generate(
                                  controller.rtnBankList.length, (index) {
                                var data = controller.rtnBankList[index];
                                return GestureDetector(
                                  onTap: () {
                                    controller.bankCharge.value = data.chargeRate.toString();
                                   Get.toNamed(Routes.CONFIRM_BANK_PAY);
