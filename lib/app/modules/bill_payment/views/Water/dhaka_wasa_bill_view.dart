...
class DhakaWasaBillView extends GetView<BillPaymentController> {
  @override
  Widget build(BuildContext context) {
    final _size = Get.size;
    var _title = Get.arguments['title'];
    var _images = Get.arguments['images'];
    var bill_payment_id = Get.arguments['bill_payment_id'];
    var bill_refer_id = Get.arguments['bill_refer_id'];
    var _bll_no = Get.arguments['bll_no'];
    var bll_amount = Get.arguments['bll_amount'];
    var bill_vat = Get.arguments['bill_vat'];
    var is_bll_pd = Get.arguments['is_bll_pd'];
    var ekpay_fee = Get.arguments['ekpay_fee'];
    var bill_total_amount = Get.arguments['bill_total_amount'];
    var _bllr_accno = "";
        ...
        body: WillPopScope(
          ...
          child: Obx(() {
            if (controller.billpayLoaded.isTrue) {
              var _total = double.parse(bill_total_amount.toString()) +
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    is_bll_pd == 'Y'
                        ...
                        : BlockButtonWidget(
                            onPressed: () {
                              ...
                              var res = BillPaymentChargePreview(bill_payment_id, bill_refer_id);
                                    ...
                                    if (value['result'] == 'success')
                                      {
                                        ...
                                        openBottomSheetBill(current_balance, bill_amount, service_charge, charge_for_online_balance_received,
                                            grand_total_amount, _bllr_accno, _title, _images, bill_payment_id, bill_refer_id)
                                      }
                                    else
                    ...
                    //       var data;
                    //       var datas;
                    //       // print(bill_payment_id);
                    //       // print(bill_refer_id);
                    //       var res = BillPayment(bill_payment_id, bill_refer_id);
                    //       Ui.customLoaderDialog();
                    //       res.then((value) => {
                    //             Get.back(),
                    //             result = value['result'],
