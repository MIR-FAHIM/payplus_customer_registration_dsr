...
class WestZonePostpaidBillView extends GetView<BillPaymentController> {
  ...
  Widget build(BuildContext context) {
    ...
    var _images = Get.arguments['images'] ?? "assets/images/default_image.png";
    ...
    var _bill_address = Get.arguments['bill_address'];
                            ...
                            MaterialPageRoute(
                              builder: (builder) =>
                                  WestZonePdfPreviewPage(
                                   ...
                                   images : Get.arguments['images'] ?? "assets/images/default_image.png",

                                   billPaymentId : Get.arguments['bill_payment_id'],
                                   billReferId : Get.arguments['bill_refer_id'],

                                   bllNo : Get.arguments['bll_no'],
                                   bllrAccno : Get.arguments['bllr_accno'],
                                   billAddress : Get.arguments['bill_address'],

                                   bllDtDue : Get.arguments['bll_dt_due'],
                                   bllAmnt : Get.arguments['bll_amnt'],
