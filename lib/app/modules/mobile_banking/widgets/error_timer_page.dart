            ...
            return Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text("Please wait 3 minutes and do not close the page. Your Cash In is processing...", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),),
                ),
                // Container(
                //   width: Get.width,
                //   color: Colors.blue,
                ...
                ).paddingSymmetric(vertical: 40, horizontal: 30) : Container()
              ],
            );
          }
        ),
